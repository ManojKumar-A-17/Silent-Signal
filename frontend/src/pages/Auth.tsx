      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-muted-foreground text-sm">
            A safe space for anonymous stress expression
          </p>
        </div>
          ...
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              {isLogin
                ...
                : "Join the community of silent support"}
            </CardDescription>
          </CardHeader>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-xs text-muted-foreground animate-fade-in">
          ...
          <span>Authentication is used only for system logic. All sharing remains anonymous.</span>
        </div>
      </div>
    </div>
  );
